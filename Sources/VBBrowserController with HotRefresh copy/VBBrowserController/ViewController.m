...
- (VBVerseReference *)verseWillAppend:(VBBrowserController *)browser currentVerseReference:(VBVerseReference *)curVerseReference requestType:(VBVerseRequestType)requestType {
    ...
    return [[VBVerseReference alloc] initWithVersionMarks:@[@"SGV", @"KJV", @";;;"] verseIndex:@((curVerseReference == NULL) ? 0 : ((requestType == VBVerseRequestTypePrevious) ? curVerseReference.verseIndex.integerValue - 1 : curVerseReference.verseIndex.integerValue + 1))];
}
